...
@section('js')
    ...
    <script nonce="{{ csp_nonce() }}">
        ...
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            var urlKategoriStatistik = new URL(`${baseUrl}/data-presisi/seni-budaya/kategori-statistik`);            
            ...
            var urlStatistik = new URL(`${baseUrl}/data-presisi/seni-budaya/statistik`);
