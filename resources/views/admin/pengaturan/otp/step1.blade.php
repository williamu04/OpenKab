    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <strong>Informasi:</strong> OTP (One Time Password) akan menjadi alternatif login tambahan untuk meningkatkan keamanan akun Anda. 
            ...
            <form id="otpSetupForm">
                ...
                <div class="form-group">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="custom-control custom-radio mt-2">
                            <input class="custom-control-input" type="radio" id="channelTelegram" name="channel" value="telegram">
                ...
                <div id="emailSection" class="form-group">
                    ...
                    <input type="email" class="form-control" id="emailInput" name="identifier" value="{{ $user->email }}" placeholder="Masukkan email Anda">
                ...
                <div id="telegramSection" class="form-group d-none">
                    ...
                    <input type="text" class="form-control" id="telegramInput" name="telegram_identifier" value="{{ $user->telegram_chat_id }}" placeholder="Masukkan Telegram Chat ID">
                    <small class="form-text text-muted">
